...
export const BOOTSTRAP_TIERS: Record<string, 'slow' | 'fast'> = {
  ...
  climateAnomalies: 'slow', climateNews: 'slow', sanctionsPressure: 'slow', radiationWatch: 'slow', thermalEscalation: 'slow', crossSourceSignals: 'slow', cyberThreats: 'slow', techReadiness: 'slow',
